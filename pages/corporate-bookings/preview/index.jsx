            ...
            <div className="flex items-start justify-between p-5 pt-0">
              <div className="flex flex-col justify-start gap-4 border-r basis-1/4">
                ...
                <Tooltip
                  ...
                  offset={5}
                  content={
                    <div className="bg-white flex justify-start gap-4 p-5 rounded-md">
                      <p
                        className="cursor-pointer font-medium text-primary hover:text-hoverPrimary flex flex-row gap-2"
                        onClick={() =>
                          handleCopy(bookingDetails?.individual_number)
                        }
                      >
                        {isCopied == bookingDetails.individual_number
                          ? "Copied!"
                          : "Copy ID"}{" "}
                      ...
                      <p
                        className="cursor-pointer font-medium text-primary hover:text-hoverPrimary flex flex-row gap-2"
                        onClick={() => handleCopy(bookingDetails?.uuid)}
                      >
                        {isCopied == bookingDetails.uuid
                          ? "Copied!"
                          : "Copy Uuid"}{" "}
                        <DocumentDuplicateIcon width={20} />
                      </p>
