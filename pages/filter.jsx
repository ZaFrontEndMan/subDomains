...
import { BookingStateSearch, CitySearch, CompanySearch, TrueOrFalseOptions } from "components/global";
...
function Filter({
  ...
  // openedContract date
  const [openedContractDateDateRange, setOpenedContractDateDateRange] = useState([null, null]);
  const [openedContractDateStartDate, openedContractDateEndDate] = openedContractDateDateRange;

  // closedContract date
  const [closedContractDateDateRange, setClosedContractDateDateRange] = useState([null, null]);
  const [closedContractDateStartDate, closedContractDateEndDate] = closedContractDateDateRange;
