...
// utils.js
export const downloadFileWithToken = (url, access_token, fileName) => {
    const link = document.createElement("a");
    link.href = `${url}?token=${access_token}`;
    link.target = "_blank";
    link.download = fileName || "file.pdf";

    // Append link to the document temporarily to trigger the click
